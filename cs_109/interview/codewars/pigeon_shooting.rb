...
def shoot(results)
  ...
  point = 0
  results.each do |rnd|
    rnd[1] == true ? point = 2 : point = 1
    rnd[0][:P1].each_char { |c| pete += point if c == 'X' }
    rnd[0][:P2].each_char { |c| phil += point if c == 'X' }
  end
  if pete > phil
    "Pete Wins!"
  elsif phil > pete
...
p shoot([[{"P1":"XX", "P2":"XO"}, true], [{"P1":"OX", "P2":"OO"}, false], [{"P1":"XX", "P2":"OX"}, true]]) == "Pete Wins!"
