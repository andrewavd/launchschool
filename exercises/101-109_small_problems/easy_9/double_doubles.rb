...
# same as its right-side digits. For example, 44, 3333, 103103, 7676 are all double numbers. 444,
...
def twice(num)
  num_as_str = num.to_s
  return num * 2 if num_as_str.size.odd?
  mid = num_as_str.size / 2
  num_as_str[0..mid - 1] == num_as_str[mid..-1] ? num : num * 2
end
