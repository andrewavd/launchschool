...
# A friend of yours wants to build a basic search engine and starts reading up on information
# extraction. He decides to try a simple implementation of TF-IDF, a measure of the information
# content a term holds for a particular document in a documetn colledction. However, he just
# started learning to code and somehow his numbers do not match what is expected. He knows
# you're enrolled in an awesome developer school, so he asks you to have a look.
...
def idf(term, documents)
  ...
  Math.log(number_of_documents.fdiv(number_of_documents_with_term)) #Math.log returns a float so shouild be working in floats, not integers.
end
