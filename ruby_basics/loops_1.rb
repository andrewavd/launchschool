...
# The code below is an example of an inginite loop. The name describes exactly what it does:
# loop infinitely. This loop isn't udeful in a real program, though.
...
while say_hello
  puts "#{count}) Hello!"
  count += 1
  say_hello = false if count > 5 # I added if statement
end
